...
describe("render a simple react-bootstrap carousel", () => {
  ...
  describe("with a default item component", () => {
    test("calculating the right css classes for its root + aspect ratio for default Item img tags", () => {
      ...
      for (const imageTag of carouselImageTags) { expect(imageTag).toHaveAttribute("height", "450"); expect(imageTag).toHaveAttribute("width", "350"); }
      ...
      for (const imageTag of carouselImageTags) { expect(imageTag).toHaveAttribute("height", "500"); expect(imageTag).toHaveAttribute("width", "350"); }
      ...
      for (const imageTag of carouselImageTags) { expect(imageTag).toHaveAttribute("height", "550"); expect(imageTag).toHaveAttribute("width", "425"); }
      ...
      for (const imageTag of carouselImageTags) { expect(imageTag).toHaveAttribute("height", "450"); expect(imageTag).toHaveAttribute("width", "330"); }
      ...
      for (const imageTag of carouselImageTags) { expect(imageTag).toHaveAttribute("height", "450"); expect(imageTag).toHaveAttribute("width", "280"); }
